...
<body class="home-page home-01 ">
    ...
    {{-- Modal Code --}}
    <div class="modal" id="modalId" style="margin-top: 250px;">
        <div class="modal-dialog bg-success">
            <div class="modal-content" style="transform: scale(1.4);">
                ...
                <div class="modal-body">
                    <div class="row mt-2 p-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <p style="box-sizing: border-box;" class="product_desc">Product description
                            </p>
                            <p>Review : &nbsp;&nbsp;&nbsp;
                            ...
                            <button class="btn btn-success mt-2" style="width: 150px;">Add to
                                Cart</button>
                        </div>
                    </div>
                </div>
